        ...
        <div className='container-fluid text-left form-dark'>
            ...
            <Form className="form" style={{ width: '300px' }}
                ...
                <FormGroup>
                    ...
                    <ExchangeDropdown value={sourceAccount} onChange={setSourceAccount} required/>
                </FormGroup>
                <FormGroup>
                    <FormLabel>Destination account</FormLabel>
                    <ExchangeDropdown value={destAccount} onChange={setDestAccount} required/>
                </FormGroup>
                <FormGroup>
                    <FormLabel>Amount</FormLabel>
                    <FormControl value={amount} onChange={setFromE(setAmount)} className='text-right' required/>
                </FormGroup>
                <FormGroup>
                    <Button type='submit'>
                        Transfer
